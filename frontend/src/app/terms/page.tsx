  ...
  return (
    <div className="container" style={{ maxWidth: 800, margin: '80px auto', padding: '0 20px' }}>
      ...
      <header style={{ marginBottom: 48, textAlign: 'center' }}>
        ...
        <p style={{ color: '#9CA3AF' }}>Last updated: February 15, 2026</p>
      </header>
      ...
      <div className="content">
        <section>
          ...
          <p>
            By accessing or using the KORTANA platform, you agree to be bound by these Terms of Service.
            KORTANA provides an autonomous layer for agent-to-agent transactions using the x402 protocol on Creditcoin.
          </p>
        </section>
        ...
        <section>
          <h2>3. Disclaimers</h2>
          <p>
            KORTANA is provided "AS IS". As a decentralized protocol, we do not have control over individual agents
        ...
        <section>
          ...
          <p>
            Users agree not to utilize KORTANA agents for illegal activities, market manipulation, or
