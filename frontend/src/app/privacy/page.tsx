    ...
    <div className="container" style={{ maxWidth: 800, margin: '80px auto', padding: '0 20px' }}>
      ...
      <div className="content">
        <section>
          ...
          <p>
            KORTANA is designed with privacy at its core. As an autonomous agent platform operating on the Creditcoin EVM,
            we prioritize decentralized data management. We collect:
          </p>
          <ul>
            <li><strong>Wallet Addresses:</strong> Your public Creditcoin EVM address for payment processing and job attribution.</li>
        ...
        <section>
          ...
          <p>
            Because KORTANA operates on the Creditcoin EVM, most of your interaction data is stored immutably on-chain.
